...
<<>>=
fit01 <- sca(dps567, dps567.idx, fmod=~1, qmod=list(~1), srmod=~1, vmod=list(~1, ~1),  n1mod=~1)
res01 <- residuals(fit01, dps567, dps567.idx)
@
...
<<meanresbyage, fig.cap="Mean fit residuals by age)">>=
...
<<>>=
fit02 <- sca(dps567, dps567.idx, fmod=~factor(age), qmod=list(~1), srmod=~1, vmod=list(~1, ~1),  n1mod=~1)
res02 <- residuals(fit02, dps567, dps567.idx)
@
...
<<fageresbyage, fig.cap="f age effect fit residuals by age)">>=
...
<<>>=
fit03 <- sca(dps567, dps567.idx, fmod=~1, qmod=list(~factor(age)), srmod=~1, vmod=list(~1, ~1),  n1mod=~1)
res03 <- residuals(fit03, dps567, dps567.idx)
@
...
<<qageresbyage, fig.cap="q age effect fit residuals by age)">>=
...
<<>>=
fit04 <- sca(dps567, dps567.idx, fmod=~factor(age), qmod=list(~factor(age)), srmod=~1, vmod=list(~1, ~1),  n1mod=~1)
res04 <- residuals(fit04, dps567, dps567.idx)
@
...
<<fqageresbyage, fig.cap="q age effect fit residuals by age)">>=
...
<<>>=
fit05 <- sca(dps567, dps567.idx, fmod=~factor(age) + factor(year), qmod=list(~factor(age)), srmod=~1, vmod=list(~1, ~1),  n1mod=~1)
res05 <- residuals(fit05, dps567, dps567.idx)
@
...
<<fyearresbyage, fig.cap="f year effect fit residuals by age)">>=
...
<<>>=
fit06 <- sca(dps567, dps567.idx, fmod=~factor(age) + factor(year), qmod=list(~factor(age)), srmod=~1, vmod=list(~1, ~1),  n1mod=~factor(age))
res06 <- residuals(fit06, dps567, dps567.idx)
@
...
<<n1resbyage, fig.cap="f year effect fit residuals by age)">>=
...
<<>>=
fit07 <- sca(dps567, dps567.idx, fmod=~factor(age) + factor(year), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))
res07 <- residuals(fit07, dps567, dps567.idx)
@
...
<<srresbyage, fig.cap="f year effect fit residuals by age)">>=
...
<<>>=
fit08a <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=15), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))
fit08b <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=10), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))
fit08c <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))

BIC(fit08a, fit08b, fit08c)

fit08d <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=7), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))
fit08e <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=6), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))
fit08f <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=4), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))
fit08g <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=3), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))
...
<<>>=
fit08 <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~factor(year), vmod=list(~1, ~1),  n1mod=~factor(age))
res08 <- residuals(fit08, dps567, dps567.idx)
@
...
<<fksresbyage, fig.cap="f year effect fit residuals by age)">>=
...
<<>>=
fit09a <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=15), vmod=list(~1, ~1),  n1mod=~factor(age))
fit09b <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=10), vmod=list(~1, ~1),  n1mod=~factor(age))
fit09c <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=5), vmod=list(~1, ~1),  n1mod=~factor(age))

BIC(fit09a, fit09b, fit09c)

fit09d <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=7), vmod=list(~1, ~1),  n1mod=~factor(age))
fit09e <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=6), vmod=list(~1, ~1),  n1mod=~factor(age))
fit09f <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=4), vmod=list(~1, ~1),  n1mod=~factor(age))
fit09g <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=3), vmod=list(~1, ~1),  n1mod=~factor(age))

BIC(fit09a, fit09b, fit09c, fit09d, fit09e, fit09f, fit09g)
@

The best model according to BIC is again \code{k = 5} for the recruitment submodel and as such the best model we get is:

<<>>=
fit09 <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=5), vmod=list(~1, ~1),  n1mod=~factor(age))
res09 <- residuals(fit09, dps567, dps567.idx)
@

<<srksresbyyear, fig.cap="f year effect fit residuals by year)">>=
plot(res09, auxline="r")
@

<<srksresbyage, fig.cap="f year effect fit residuals by age)">>=
...
<<>>=
fit10 <- sca(dps567, dps567.idx, fmod=~factor(age) + s(year, k=5), qmod=list(~factor(age)), srmod=~s(year, k=5), vmod=list(~s(age, k=4), ~1),  n1mod=~factor(age))
res10 <- residuals(fit10, dps567, dps567.idx)
@
...
flqs <- FLQuants(mod10=catch.n(dps567+simulate(fit10, nsim=500))[,"2022"], mod09=catch.n(dps567+simulate(fit09, nsim=500))[,"2022"])
...
<<vageresbyage, fig.cap="f year effect fit residuals by age)">>=
